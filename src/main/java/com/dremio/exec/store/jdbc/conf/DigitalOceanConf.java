...
@SourceType(value = "DigitalOceanARP", label = "DigitalOcean",uiConfig = "digitalocean-layout.json")
public class DigitalOceanConf extends AbstractArpConf<DigitalOceanConf> {
  private static final String ARP_FILENAME = "arp/implementation/digitalocean-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.digitalocean.DigitalOceanDriver";
